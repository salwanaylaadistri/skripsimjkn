...
const riwayatList = [
  {
    faskes: "Klinik Indi Medika",
    tanggal: "10 Juni 2026",
    rating: 5,
    diagnosa: "Infeksi saluran pernapasan atas (ISPA)",
    keluhan: "Batuk dan pilek selama 3 hari",
    terapiObat: "Amoxicillin 500mg, CTM",
    terapiNonObat: "Istirahat cukup, minum air putih",
    rekamMedis: true,
    suratRujukan: null,
  },
  {
    faskes: "Puskesmas Depok II",
    tanggal: "22 April 2026",
    rating: 4,
    diagnosa: "Gastritis akut",
    keluhan: "Nyeri ulu hati dan mual",
    terapiObat: "Antasida, Omeprazole 20mg",
    terapiNonObat: "Diet makanan lunak",
    rekamMedis: true,
    suratRujukan: null,
  },
  {
