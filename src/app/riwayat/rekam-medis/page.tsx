    ...
    <div className="flex flex-col min-h-full bg-gray-50">
      <div className="sticky top-0 z-10" style={{ background: GRADIENT }}>
        ...
        <div className="relative px-4 pb-6 pt-6">
          ...
          <h1 className="text-white font-bold text-lg text-center">Rekam Medis Elektronik</h1>
        </div>
      </div>
      ...
      <div className="flex-1 px-4 pt-5 pb-6 flex flex-col gap-4">
        <div className="bg-white border-2 border-[#184087] rounded-2xl p-5 flex flex-col gap-3">
          <h2 className="text-[#184087] font-bold text-base text-center">Rekam Medis Elektronik</h2>
          <p className="text-gray-400 text-xs text-center">Gadjah Mada Medical Center Â· 16 April 2026</p>

          {[
            { label: "No. Rekam Medis", value: "RM-2026-00123" },
            { label: "Nama Pasien", value: typeof window !== "undefined" ? (localStorage.getItem("jkn_user_nama") ?? "-") : "-" },
            { label: "Tanggal Lahir", value: "15 Maret 2002" },
            { label: "No. BPJS", value: typeof window !== "undefined" ? (localStorage.getItem("jkn_nik") ?? "-") : "-" },
            { label: "Faskes", value: "Gadjah Mada Medical Center" },
            { label: "Tanggal Kunjungan", value: "16 April 2026" },
            { label: "Dokter Pemeriksa", value: "dr. Aldhi Nadir" },
            { label: "Diagnosa", value: "Pemeriksaan general tanpa komplain dan keluhan" },
            { label: "Keluhan", value: "Pemeriksaan Mahasiswa KKN" },
            { label: "Terapi Obat", value: "-" },
            { label: "Terapi Non Obat", value: "-" },
            { label: "Catatan", value: "Kondisi umum baik. Tidak ditemukan kelainan yang signifikan." },
          ].map((row) => (
